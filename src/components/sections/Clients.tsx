    ...
    <div className='mt-[100px]'>
      ...
      <div className='relative'>
        ...
        <div className='max-w-[1200px] mx-auto space-y-[79.75px] pt-[42.91px]'>
          <div className='flex flex-col px-4 md:px-0 md:flex-row space-y-4 md:space-y-0 justify-between'>
          ...
          <div className='flex flex-col md:flex-row items-stretch justify-between gap-[32px] -pb-24'>
